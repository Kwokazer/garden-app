...
Revision ID: a0cddd87dfb9
Revises: 
Create Date: 2025-05-17 01:00:46.560254
...
def upgrade() -> None:
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('growth_height_min', sa.Float(), nullable=True),
    sa.Column('growth_height_max', sa.Float(), nullable=True),
    ...
    sa.Column('bloom_season', sa.String(length=50), nullable=True),
    ...
    op.create_index('ix_question_tag_question', 'question_tag', ['question_id'], unique=False)
    op.create_index('ix_question_tag_tag', 'question_tag', ['tag_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_question_tag_tag', table_name='question_tag')
    op.drop_index('ix_question_tag_question', table_name='question_tag')
